...
class ADLSConnector:
    ...
    def upload(self, data, path):
        ...
        '''
        print(f'uploading adls {data} to the path {path}') 

class AdlsPlugin(object):
    ...
    def setup(self, app):
        ...
        for other in app.plugins:
            if not isinstance(other, AdlsPlugin): continue
    ...
    def apply(self, callback, context):
        ...
        conf = context.config.get('adls') or {}
        ...
        if file_type and file_type != 'ADLS':
            return callback
